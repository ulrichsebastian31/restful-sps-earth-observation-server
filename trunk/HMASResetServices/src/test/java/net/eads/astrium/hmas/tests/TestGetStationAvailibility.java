 ...
 *   Project                                            :               DREAM
 * --------------------------------------------------------------------------------------------------------
 *   File Name                                          :               TestGetStationAvailibility.java
 ...
 * @author re-sulrich
 */
public class TestGetStationAvailibility {
    ...
    @Test
    public void getStationAvailibility()
    {
        ...
        queryParams.add("request", "GetStationAvailibility");
        queryParams.add("acceptFormat", "application/xml");
        queryParams.add("stationId", "station1");
