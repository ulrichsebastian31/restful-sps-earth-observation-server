...
public class ReserveParser {
    ...
    public ReserveDocument createXMLReserve(MultivaluedMap<String, String> params)
            throws MissingParameterException, XMLParsingException, ParseException
    {
        ...
        //Create XML request
        ReserveDocument doc = ReserveDocument.Factory.newInstance();
        ReserveType getFeas = doc.addNewReserve();
    ...
    public ReserveDocument createXMLReserve(String xmlRequest)
            throws MissingParameterException, XMLParsingException
    {
        ReserveDocument doc = null;
        try {
            doc = ReserveDocument.Factory.parse(xmlRequest);
