...
public class GetFeasibilityFault extends OWSException {
    ...
    public GetFeasibilityFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception) {
        super(CODE,message, exception);
    }

    public GetFeasibilityFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception, Throwable cause) {
