...
public class GetTaskFault extends OWSException {
    ...
    public GetTaskFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception) {
        super(CODE,message, exception);
    }

    public GetTaskFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception, Throwable cause) {
