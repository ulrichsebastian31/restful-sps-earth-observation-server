...
public class SubmitParser {
    ...
    public SubmitDocument createXMLSubmit(MultivaluedMap<String, String> params)
    ...
    public SubmitDocument createXMLSubmit(String xmlRequest)
            throws MissingParameterException, XMLParsingException
    {
        SubmitDocument doc = null;
        try {
            doc = SubmitDocument.Factory.parse(xmlRequest);
