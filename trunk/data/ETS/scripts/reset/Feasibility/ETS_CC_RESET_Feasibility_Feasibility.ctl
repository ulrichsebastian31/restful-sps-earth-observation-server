...
<ctl:package 
 ...
 -->
	<xi:include href="ETS_CC_RESET_Feasibility_ATS_14.2.1.1_POST_Feasibility.ctl"/>
	<xi:include href="ETS_CC_RESET_Core_ATS_14.2.1.2_GET_Task_Status.ctl"/>
	<xi:include href="ETS_CC_RESET_Core_ATS_14.2.1.3_GET_Task.ctl"/>
	<xi:include href="ETS_CC_RESET_Feasibility_ATS_14.2.1.4_POST_Feasibility_non_nominal_conditions.ctl"/>
	<!--
	<xi:include href="ETS_CC_RESET_Core_ATS_14.2.1.5_GET_Task_Status_non_nominal_conditions.ctl"/>
	<xi:include href="ETS_CC_RESET_Core_ATS_14.2.1.6_GET_Task_non_nominal_conditions.ctl"/>
	-->
	
	<ctl:test name="reset:RESET_Feasibility_Feasibility_Tests">
		...
		<ctl:assertion>To verify whether the RESET Server under test implements the Feasibility resource.</ctl:assertion>
		<ctl:link title="14.1.2 Feasibility">http://www.opengis.net/spec/RESET/1.0/conf/Core/Feasibility</ctl:link>
		<ctl:code>
		<!--
			-->
			<ctl:message>#######################################################################</ctl:message>
			<ctl:message>ATS section: 14.2.1.1	POST Feasibility </ctl:message>
			<ctl:message>For procedure : <xsl:value-of select="$cc.procedure"/> </ctl:message>
			<ctl:message>#######################################################################</ctl:message>
			<ctl:call-test name="reset:ATS_14.2.1.1_POST_Feasibility">
			...
			<ctl:message>#######################################################################</ctl:message>
			<ctl:message>ATS section: 14.2.1.2	GET Task Status  </ctl:message>
			<ctl:message>#######################################################################</ctl:message>
			<ctl:call-test name="reset:ATS_14.2.1.2_GET_Task_Status">
				<ctl:with-param name="sp.endpoint.HTTP.url" select="$sp.endpoint.HTTP.url"/>
				<ctl:with-param name="cc.resetschema_URL" select="$cc.resetschema_URL"/>
				<ctl:with-param name="cc.ows_schema_URL" select="$cc.ows_schema_URL"/>
				<ctl:with-param name="cc.messagedir" select="$cc.messagedir"/>
			...
			<ctl:message>#######################################################################</ctl:message>
			<ctl:message>ATS section: 14.2.1.3	GET Task </ctl:message>
			<ctl:message>#######################################################################</ctl:message>
			<ctl:call-test name="reset:ATS_14.2.1.3_GET_Task">
				<ctl:with-param name="sp.endpoint.HTTP.url" select="$sp.endpoint.HTTP.url"/>
				<ctl:with-param name="cc.resetschema_URL" select="$cc.resetschema_URL"/>
				<ctl:with-param name="cc.ows_schema_URL" select="$cc.ows_schema_URL"/>
				<ctl:with-param name="cc.messagedir" select="$cc.messagedir"/>
			...
			<ctl:message>#######################################################################</ctl:message>
			<ctl:message>ATS section: 14.2.1.4	POST Feasibility non nominal conditions  </ctl:message>
			<ctl:message>#######################################################################</ctl:message>
			<ctl:call-test name="reset:ATS_14.2.1.4_POST_Feasibility_non_nominal_conditions">
				<ctl:with-param name="sp.endpoint.HTTP.url" select="$sp.endpoint.HTTP.url"/>
				<ctl:with-param name="cc.resetschema_URL" select="$cc.resetschema_URL"/>
				<ctl:with-param name="cc.ows_schema_URL" select="$cc.ows_schema_URL"/>
				<ctl:with-param name="cc.messagedir" select="$cc.messagedir"/>
