...
public class DescribeSensorFault extends OWSException {
    ...
    public DescribeSensorFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception) {
        super(CODE,message,exception);
    }

    public DescribeSensorFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception, Throwable cause) {
