...
public class CancelFault extends OWSException {
    ...
    public CancelFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception) {
        super(CODE, message);
        this.exception = exception;
    }

    public CancelFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception, Throwable cause) {
