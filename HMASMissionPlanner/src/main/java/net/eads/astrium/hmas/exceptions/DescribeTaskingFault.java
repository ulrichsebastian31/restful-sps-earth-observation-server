...
public class DescribeTaskingFault extends OWSException {
    ...
    public DescribeTaskingFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception) {
        super(CODE,message,exception);
    }

    public DescribeTaskingFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception, Throwable cause) {
