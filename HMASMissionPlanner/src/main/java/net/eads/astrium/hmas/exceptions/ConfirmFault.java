...
public class ConfirmFault extends OWSException {
    ...
    public ConfirmFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception) {
        super(CODE,message,exception);
    }

    public ConfirmFault(String message, net.opengis.ows.x11.ExceptionReportDocument exception, Throwable cause) {
