...
<ctl:package 
 ...
 <!-- CTL FILE METADATA
  ...
  Lineage: 2014/05/01 - ASTRIUM
	-->
	<ctl:test name="reset:ATS_14.2.1.2_GET_Task_Status">
		...
		<ctl:link title="14.2.1.2 Get Task Status">http://www.opengis.net/spec/RESET/1.0/conf/Feasibility/GET_Feasibility_Status/</ctl:link>
		<ctl:code>
			<!-- #############################################################################################  -->
			<!-- #
		...
		Verify the response message:
			...
			<xsl:variable name="endpoint.description" select="concat($sp.endpoint.HTTP.url,'feasibility/', $feasibility.task, '/')"/>
