...
<ctl:package 
  ...
  -->
	...
	<xi:include href="ETS_CC_RESET_Planning_Planning.ctl"/>
	
	<!-- ************************************************************************************************* 
   This Conformance Class is in charge of verifying the compliance of the RESET Server under test with 
       respect to the Planning Requirement Class, which includes the basic functions that every RESET Server 
       shall implement planning analysis creation and retrieval
       ************************************************************************************************* -->
	<ctl:test name="reset:RESET_Planning_Conformance_Class">
		...
		<ctl:param name="cc.sensor.type">Sensor Type</ctl:param>
		<ctl:assertion>Tests for verifying the compliance with respect to Planning Conformance Class</ctl:assertion>
	...
	-->    
		...
		<ctl:message>Planning resource verification (ATS sections: 14.3.1)  ##</ctl:message>
		<ctl:message>Sensor Type SAR, procedure is : <xsl:value-of select="$cc.procedure"/> ## </ctl:message>
		<ctl:message>#######################################################################</ctl:message>
		
		<ctl:call-test name="reset:RESET_Planning_Planning_Tests">
