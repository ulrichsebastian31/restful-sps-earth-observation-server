  ...
  -->
	...
	<ctl:test name="reset:RESET_Compliance_Tests">
		...
		<ctl:code>
			...
			<xsl:variable name="sp.endpoint.HTTP.url">http://91.183.191.131/HMASResetServices/hmas/reset/1.0.0/</xsl:variable>
			...
			<xsl:variable name="cc.procedure">S1ASAR</xsl:variable>
			<xsl:variable name="cc.sensor.type">SAR</xsl:variable>
			...
			<ctl:message> the procedure to try is : <xsl:value-of select="$cc.procedure"/>
			</ctl:message>
			<ctl:message> the sensor type to try is : <xsl:value-of select="$cc.sensor.type"/>
			</ctl:message>
			<!-- ############################################################################################################ -->
			<ctl:message>------------------------------------------------------</ctl:message>
